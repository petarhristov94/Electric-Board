...
short failCount;
const uint64_t pipe = 0xE8E8FFFF61LL; // If you change the pipe, you will need to update it on the receiver to.
...
void transmitToVesc() {
  ...
  if (millis() - lastTransmission >= 50) {
    ...
    Serial.print("Send success status: ");Serial.println(sendSuccess);
...
void calculateThrottlePosition() {
  ...
  //Serial.print("Hall Measurement Value: ");Serial.print( (String)hallMeasurement );Serial.print(" | ");Serial.print("Calculated Trigger Value: ");Serial.println( (String)throttle );
}
